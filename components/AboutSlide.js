...
const AboutSlide = props => {
	...
	const mainHeadingOpacity = useTransform(scrollYProgress, [0.17, 0.25, 0.35, 0.43], [0, 1, 1, 0])
	const mainHeadingY = useTransform(scrollYProgress, [0.17, 0.25], [150, 0])
	const mainHeadingScale = useTransform(scrollYProgress, [0.4299, 0.43], [1, 0])
